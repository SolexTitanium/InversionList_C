...
int main(void) {
  inversion_list_init();
  {
    ...
    assert(inversion_list_greater_equal(set_a, set_b));
    assert(inversion_list_greater_equal(set_a, set_c));
    assert(!inversion_list_greater_equal(set_a, set_d));
    assert(!inversion_list_greater_equal(set_b, set_d));
    assert(!inversion_list_greater_equal(set_d, set_b));
    assert(!inversion_list_greater_equal(set_c, set_d));
    assert(!inversion_list_greater_equal(set_d, set_c));
    assert(inversion_list_greater_equal(set_e, set_a));
    assert(!inversion_list_greater_equal(set_a, set_e));
    assert(!inversion_list_greater_equal(set_e, set_f));
    assert(inversion_list_greater_equal(set_a, set_a));
