...
int main(void) {
  inversion_list_init();
  {
    ...
    intersection_set = inversion_list_intersection(set_a_uint8, set_a_uint8);
    ...
    intersection_set = inversion_list_intersection(set_a_uint16, set_a_uint8);
    ...
    intersection_set = inversion_list_intersection(set_a_uint16, set_a_uint32);
    ...
    intersection_set = inversion_list_intersection(set_a_uint8, set_b_uint8);
    assert(intersection_set->capacity == 100);
    ...
    intersection_set = inversion_list_intersection(set_a_uint16, set_b_uint32);
    assert(intersection_set->capacity == 100000);
    assert(intersection_set->support == 1);
    assert(intersection_set->size == 2);
    assert(intersection_set->couples.uint32[0] == 1);
    ...
    intersection_set = inversion_list_intersection(set_c_uint8, set_d_uint8);
    assert(intersection_set->capacity == 100);
    ...
    intersection_set = inversion_list_intersection(set_c_uint32, set_d_uint8);
    assert(intersection_set->capacity == 100000);
    assert(intersection_set->support == 5);
    assert(intersection_set->size == 4);
    ...
    intersection_set = inversion_list_intersection(set_e_uint8, set_e_uint8);
    assert(intersection_set->capacity == 100);
    assert(intersection_set->support == 0);
    assert(intersection_set->size == 0);
    inversion_list_destroy(intersection_set);

    intersection_set = inversion_list_intersection(set_e_uint8, set_e_uint16);
    assert(intersection_set->capacity == 1000);
    assert(intersection_set->support == 0);
    assert(intersection_set->size == 0);
    inversion_list_destroy(intersection_set);

    intersection_set = inversion_list_intersection(set_e_uint8, set_d_uint8);
    assert(intersection_set->capacity == 100);
    assert(intersection_set->support == 0);
    assert(intersection_set->size == 0);
    inversion_list_destroy(intersection_set);

    intersection_set = inversion_list_intersection(set_e_uint32, set_d_uint16);
    assert(intersection_set->capacity == 100000);
    assert(intersection_set->support == 0);
    assert(intersection_set->size == 0);
    inversion_list_destroy(intersection_set);
